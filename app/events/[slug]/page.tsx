      ...
      <Container className="py-10">
        <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
          <div>
            ...
            <h2 className="mt-5 text-2xl font-semibold">Event overview</h2>
            <p className="mt-3 max-w-3xl text-base leading-7 text-foreground/68">
              This page proves the first public event detail route, connected stage data,
              timeline records, weather snapshot, and timing table.
            </p>
          </div>
